...
import banner from "../../assets/img/bannerSuscriptions.png";
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.selector}>
        <div> {translate("Confederation", userLogged.language)}</div>
        <div>
          <KeyboardArrowUpIcon />
        </div>
      </div>
      ...
      <div className={classes.selector}>
        <div> {translate("Federation", userLogged.language)}</div>
        <div>
          <KeyboardArrowUpIcon />
        </div>
      </div>
      ...
      <div className={classes.containerFederation}>
        <div className={classes.headerFederation}>
          <div className={classes.headerFederationContent}>
            {selectClubTeamPlayer === "CLUBS" ? (
              ...
              >
                {translate("CLUBS", userLogged.language)}
              </p>
            ) : (
              <p
                className={classes.titleCategory}
            ...
            {selectClubTeamPlayer === "TEAMS" ? (
              <p
                ...
                style={{ borderBottom: "4px solid #00FFFF" }}
              >
                {translate("TEAMS", userLogged.language)}
              </p>
            ) : (
              <p
                className={classes.titleCategory}
            ...
            {selectClubTeamPlayer === "PLAYERS" ? (
              <p
                ...
                style={{ borderBottom: "4px solid #00FFFF" }}
              >
                {translate("PLAYERS", userLogged.language)}
              </p>
            ) : (
              <p
                className={classes.titleCategory}
        ...
        {federation !== "" ? (
          <>
            <div className={classes.bodyFederation}>
              <div className={classes.searchAndOrderBy}>
                <div>
                  <input
                    placeholder={`${translate("Search", userLogged.language)}`}
                ...
                <div>
                  ...
                  >
                    {selectedOption === "Sort by" && (
                      <option>
                        {translate(selectedOption, userLogged.language)}
                      </option>
                    )}
                    <option value="Sort A-Z">
                      {translate("Sort A-Z", userLogged.language)}
                    </option>
                    <option value="Sort Z-A">
                      {translate("Sort Z-A", userLogged.language)}
                    </option>
                    <option value="Best sellers">
                      {translate("Best sellers", userLogged.language)}
                    </option>
                  </select>
                </div>
              </div>
          ...
          <div className={classes.bodyFederationEmpty}>
            {translate("Select Federation", userLogged.language)}
          </div>
        )}
      </div>
    </div>
...
export default SuscriptionsFan;
